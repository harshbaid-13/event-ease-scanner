    ...
    <>
      <div className="h-screen flex flex-col items-center justify-center gap-5">
        <div className="flex flex-col items-center justify-center">
          <h2 className="text-2xl font-bold">Event Ease Scanner</h2>
          <h3 className="text-xl">Powered by The Coders Club by TSC</h3>
        </div>
        {results ? (
          option ? (
            <div>
              ...
              <div className="w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div className="relative w-full max-w-md max-h-full">
                  <div
                    className={
                      "relative bg-white border-4 rounded-lg shadow border-gray-500"
                    }
                  >
                    <div className="p-6 text-center">
                      ...
                      <h3 className="mb-10 text-lg font-normal text-gray-800 ">
                        {message}
                      </h3>
                      {success ? (
                        <button
                ...
                <div className="relative w-full max-w-md max-h-full">
                  <div className="relative bg-gray-700 rounded-lg shadow ">
                    <div className="p-6 text-center">
                      ...
                      <h3 className="mb-10 text-lg font-normal  text-gray-100">
                        {results}
                      </h3>
                      <button
